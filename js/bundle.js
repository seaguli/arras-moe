  ...
  (function(r) {
      ...
      const Ra = (() => {
              ...
              }
              {
                ...
                if (z.name.includes("Seaguli"))
                  N.draw(
                    ...
                    Math.round(d - 10 - 4) + 0.5,
                    32,
                    150 > Date.now() % 300 ? "#db8cff" : "#db8cff",
                    "center"
                  );
                if (z.name.includes("Crewmate"))
                  N.draw(
                    ...
                    Math.round(d - 10 - 4) + 0.5,
                    32,
                    150 > Date.now() % 300 ? l.blue : l.blue,
                    "center"
                  );
                if (z.name.includes("Ghastboo"))
                  N.draw(
                    z.name,
                    Math.round(c + 165) + 0.5,
                    Math.round(d - 10 - 4) + 0.5,
        ...
        Ta = (() => {
          ...
          return () => {
            ...
            if (z.name.includes("Impostor"))
              a.draw("wait, what?", d, n - 60, 10, l.guiwhite, "center");
            if (z.name.includes("[AI]"))
              a.draw(
                "stop playing as a robot",
                d,
                n - 60,
                10,
                l.guiwhite,
    ...
    function(r, p) {
      ...
      p.formatLargeNumber = a =>
        1e18 > a ? a.toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "a lot";
      p.pullJSON = a => {
        if (window.fetch)
          return fetch(a, {
            cache: "no-cache"
            ...
            case 72:
              if (!a.died) {
                if (a.isChatMode === false) {
                  ...
                  chatInput.style.font = "bold 18px freude-regular";
