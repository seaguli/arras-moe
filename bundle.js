...
smallaudio.src = ("https://cloud-cube.s3.amazonaws.com/m660o440l0wv/public/select.ogg");
                    ...
                    return c => {
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("𝗮𝗿𝗿𝗮𝘀.𝗶𝗼", h + 200, m - 2, 15, l.guiwhite, "right");
                                else {
                                    if (b.showDebug) {
                                        W[6].draw("𝗮𝗿𝗿𝗮𝘀.𝗶𝗼",
